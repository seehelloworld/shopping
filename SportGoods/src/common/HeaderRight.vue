<template>
  <div class="header-box">
      <header class="w">
        <div class="w-box">
          <div class="nav-logo">
              <span style="padding-right: 0%;"><i class="icon icon-phone"></i> 0500-6000000</span>
              <span><i class="icon icon-time"></i> 上午9点至下午6点</span>
          </div>
          <div class="right-box">
            <div class="nav-list">
                ...
                <div class="nav-user-wrapper pa" v-if="login">
                  <div class="nav-user-list">
                    <ul>
                      ...
                      <li>
                        <router-link to="/user/informations">账号资料</router-link>
                      </li>
                      <li>
