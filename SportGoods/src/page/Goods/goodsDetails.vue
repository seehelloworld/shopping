    ...
    <div class="gray-box">
      <div class="gallery-wrapper">
        <div class="gallery">
          <div class="thumbnail">
            <ul>
              <li v-for="item in small" :class="{on:big===item}" @click="big=item" :key="item">
          ...
          <div class="thumb">
            <div class="big">
              <img :src="product.productImageBig" :alt="product.productName">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="banner">
        <div class="sku-custom-title">
          ...
          <h6>
            <span>{{ product.productClass }} | {{product.factory}} | {{product.productColor}} </span>
            <span class="price">
              <em style="font-size:22px">¥</em> {{product.salePrice}}</span>
          </h6>
        </div>
        <div class="num">
    ...
    <div class="item-info">
      <y-shelf title="产品信息">
        <div  slot="content">
          ...
          <div style="font-size:16px;line-height:40px;" class="no-info" >
            <!-- 该产品暂无内容 -->
            {{productMsg}}
            <!-- <div v-for="item in computer" :key="item._id">
              <img style="width:1120px" :src="item.detialsimg"  alt="">
            </div> -->
            <!-- <img src="/static/images/h-slid1.jpg" alt=""> -->
            <div>
              <img style="width:1120px" :src="product.detialsimg" alt="">
            </div>
          </div>
        </div>
      </y-shelf>
