                  ...
                  <div class="cart-top-items">
                    <div class="cart-items clearfix">
                      ...
                      <div class="shop-left">
                        ...
                        <span class="blue-checkbox-new radio" :class="  {'checkbox-on':item.checked === '1'}"
              ...
              <div class="shipping">
                <div class="shipping-box">
                  <div class="shipping-total shipping-num"><h4
                    class="highlight">已选择 <i v-text="1"></i> 件商品</h4>
                    <h5>共计 <i v-text="1"></i> 件商品</h5></div>
                  <div class="shipping-total shipping-price"><h4
                    class="highlight">应付总额：<span>￥</span><i v-text="2800"></i>
                  </h4>
                    <h5 class="shipping-tips ng-scope">应付总额不含运费</h5>
                  </div>
                </div>
                <y-button :classStyle="1 > 0?'main-btn':'disabled-btn'"
                          class="big-main-btn"
