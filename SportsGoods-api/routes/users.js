    ...
    if (err) {
      ...
      if (doc) {
        ...
        User.insertMany({
          userName: userName,
          name: 'biubiubiu',
          avatar: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1510123669178&di=b6156e98fea3dfbae0f68562ed8fbb83&imgtype=0&src=http%3A%2F%2Fimg.popoho.com%2FUploadPic%2F2010-2%2F201022512934779.jpg',
          userId: userId,
          userPwd: userPwd,
          orderList: [],
          cartList: [],
...
router.post('/upload', function (req, res, next) {
  ...
  fs.writeFile(filePath, dataBuffer, function (err,result) {
    if (err) {
